...
glm.US_h12_roll = glm.roc_roll(zoo.US_lag0_big, forecast = 12, varname = "SFYGT1", country = "US")
...
glm.US_h3_roll_crap = glm.roc_roll_old(zoo.US_lag0_big, forecast = 3, varname = "PMNO", country = "US")
glm.US_h6_roll_crap = glm.roc_roll_old(zoo.US_lag0_big, forecast = 6, varname = "EXRUK", country = "US")
glm.US_h12_roll_crap = glm.roc_roll_old(zoo.US_lag0_big, forecast = 12, varname = "SFYGT5", country = "US")
...
#Big Boost: Serena 
gbm.US_h3d3_roll_serena = gbm.roc_roll(forecast = 3, lags = 3, zoo.C_lag0 = zoo.US_lag0_big, run.full = TRUE, country = "US", input_end = "1977-02-01", manual_end = TRUE)
gbm.US_h6d3_roll_serena = gbm.roc_roll(forecast = 6, lags = 3, zoo.C_lag0 = zoo.US_lag0, run.full = TRUE, country = "US", input_end = "1977-02-01", manual_end = TRUE)
gbm.US_h12d4_roll_serena = gbm.roc_roll(forecast = 12, lags = 4, zoo.C_lag0 = zoo.US_lag0_big, run.full = TRUE, country = "US", input_end = "1977-02-01", manual_end = TRUE)
